# 文章執筆上のルール
1. 句読点に何を用いるか、については規定はありません
、。でも，．でも、好きな方を使ってもらって構いませんが論文中では必ず統一してください
句読点が混じっているやつは、コピペの疑いが強いと判断されることが多く、体裁面の部分で相当厳しいことを言われます

2. () の使い方
カッコの使い方ですが、科学論文の場合には半角カッコが多いです。この半角カッコの前後には半角のスペースを入れます。ただし、句読点の前の)についてはスペースは省いてOKです。
参考文章
...
3. 数字と単位の間には半角スペースを入れる
例:3 km

4. 引用文献
引用文献の入れ方にはいくつかのスタイルがあります。
本文中に引用を番号で示すか、Takaya et al. (2018) みたいに示すかですが、これについてはどちらでもいいです。
ただしこちらも論文を通して必ず統一して下さい
